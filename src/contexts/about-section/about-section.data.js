...
export const ABOUT_DATA = [
    ...
    {
        id: uuid(),
        fadedTitle: "What we do",
        title: "Web design",
        content: `Does your business exist? Then your business needs a website. The internet has over
        the years proven to be a place that breaks barriers with respect to a business reaching its valued
         customers and what better way to reach your audience but with a website that grants your users the 
         best of experiences. And that is exactly what wevops stands to offer.`
    },
    {
        id: uuid(),
